...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#f4f5f7] via-[#faf8ff] to-[#f4f5f7] px-4 py-10">
      ...
      <Backlight className="w-full max-w-md relative z-10">
        <Card className="w-full bg-[#ffffff]/80 backdrop-blur-xl border-[#e5e7eb] shadow-[0_8px_32px_rgba(26,28,36,0.14)]">
